...
const ProjectsSection = () => {
  ...
  const projects = [
  {
    ...
    fullDescription: "Developed using Arduino and IoT simulations, this project monitors soil health parameters to support precision farming. Implemented on Wokwi for virtual hardware simulation, with efficient water usage insights and automated alerts.",
    ...
    fullDescription: "Designed an embedded system with sensors to measure temperature, humidity, and pressure. Features include wireless data transmission, local storage, and real-time monitoring for environmental analysis.",
  ...
  },
  {
    ...
    fullDescription: "Implemented with Python and OpenCV, this project applies image processing techniques to detect and classify fruits virtually. Showcases feature extraction, color-based classification, and automation in sorting applications.",
  ...
  },
  {
    ...
    fullDescription: "Explored MATLAB Onramp, Simulink modeling, and Image Processing applications to strengthen theoretical and simulation knowledge. Projects included signal processing, control system analysis, and feature extraction experiments.",
